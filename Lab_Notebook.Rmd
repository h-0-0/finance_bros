...
To help in this analysis we use many functions from the SVMForecast package that we created. It contains many helpful functions for pulling stock data and fitting, tuning and plotting SVM's. The package is fully documented and largely tested and can be viewed at github: "github.com/h-aze/finance_bros" under the SVMForecast directory.  
